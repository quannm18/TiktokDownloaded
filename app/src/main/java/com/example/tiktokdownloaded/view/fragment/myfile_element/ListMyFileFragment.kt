...
import com.example.tiktokdownloaded.adapter.TikTokChildAdapter
import com.example.tiktokdownloaded.adapter.TikTokParentAdapter
...
class ListMyFileFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val adapter = TikTokParentAdapter()
...
//                val element = tikTokEntity
            ...
            adapter.setDataParent(listParent)
...
//    private fun returnListOfTitle(i : Int, listEntity: List<TikTokEntity>, listTitle: Set<String>) : TikTokRow{
